...
class CSSMViT(nn.Module):
    ...
    @nn.compact
    def __call__(self, x: jnp.ndarray, training: bool = True, return_activations: bool = False,
        ...
        Args:
            ...
            return_activations: If True, return (logits, activations), where
                           activations is a dictionary with the activations for each layer
                           NOTE: return_spatial will supersede return_activations
